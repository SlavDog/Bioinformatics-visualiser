        ...
        subjectList
            ...
            .forEach((choiceSubject) => {
                ...
                if (!choiceCode.includes('core') && !choiceCode.includes('tv')) {
                    successors = connectPredsOrSuccs(
                        true,
                        choices[choiceCode],
                        details,
                        choiceCode,
                    ...
                    predecessors = connectPredsOrSuccs(
                        false,
                        choices[choiceCode],
                        details,
                        choiceCode,
...
function connectPredsOrSuccs(
    ...
    const neighboursArray = allNeighbours.filter(
    ...
    neighboursArray.forEach((neighbour) => {
        ...
        details[neighbour.code][inverseKey] = details[neighbour.code][inverseKey].filter(
    ...
    if (connectSuccs) {
        replaceChoiceSubjectsFromSuccGroups(
            neighboursArray,
            choiceNodeCode,
            choiceListCodes,
            details,
...
function replaceChoiceSubjectsFromSuccGroups(
...
function saveChoiceNode(
    ...
    newSpec[selectedSpecialization]['plan'][semester] = newSpec[selectedSpecialization]['plan'][
        semester
