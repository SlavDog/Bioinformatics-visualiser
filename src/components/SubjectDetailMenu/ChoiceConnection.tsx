            ...
            <Tippy content={text} disabled={color === 'transparent' || !text}>
                <svg width={w} height={subjectHeight / 2}>
                    ...
                    >
                        ...
                        />
                        <polygon
                            points={`${arrowX - 5},${centerY - 5} ${arrowX - 5},${centerY + 5} ${arrowX},${centerY}`}
                            fill={color}
                        />
                        <circle
                            cx={cx}
        ...
        <Tippy content={text} disabled={color === 'transparent' || !text}>
            <svg width={subjectWidth / 2} height="60">
                ...
                >
                    ...
                    />
                    <polygon
                        points={`${x - 5},${yEnd} ${x + 5},${yEnd} ${x},${yEnd + 5}`}
                        fill={color}
                    />
                    <circle
                        cx={x}
                        cy={isPredecessor ? 15 : 45}
                        r="10"
                        fill="transparent"
                        stroke={color}
                        strokeWidth="2"
